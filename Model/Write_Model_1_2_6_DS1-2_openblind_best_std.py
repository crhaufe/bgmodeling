...
l2_full_set = GetFullL2DCHWTupleSet('DS1-2')
...
for (dC, hwC) in l2_floated_set:
    ...
    component_dict = {
     ...
     'config': 'DS1-2',
     'cut': 6, # implies data cut
     'data_cut_scheme': 'RmD_M1Enr', # needed for correct data file
     'detector_type': '2', # invokes spec_detector_type
     'decay_chain_segment': None,
     'decay_chain': dC,
     'hardware_component': hwC,
     'generator': generator,
     'dataset': 'DS12', # spec_ds is an option elsewhere
     'datatype': 'ThM1',
     'pdftype': 'best_std',
     'id': None,
