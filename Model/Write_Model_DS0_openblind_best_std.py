...
l2_full_set = GetFullL2DCHWTupleSet('DS0')
...
for (dC, hwC) in l2_floated_set:
    ...
    component_dict = {
     ...
     'config': 'DS0',
     'cut': None, # implies data cut
     'data_cut_scheme': None, # needed for correct data file
     'detector_type': None, # invokes spec_detector_type
     'decay_chain_segment': None,
     'decay_chain': dC,
     'hardware_component': hwC,
     'generator': generator,
     'dataset': 'DS0', # spec_ds is an option elsewhere
     'datatype': 'ThM1',
     'pdftype': 'best_std',
     'id': None,
